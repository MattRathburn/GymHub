...
global using Polly;
global using GH.Identity.API.Configuration;
global using GH.Identity.API.Data;
global using GH.Identity.API.Models;
global using GH.Identity.API.Services;
global using GH.Identity.API.Extensions;